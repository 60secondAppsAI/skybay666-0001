...
<template>
  ...
  <base-input label="ExperienceYears" type="text" placeholder="Enter ExperienceYears" v-model="pilotToAdd.experienceYears"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'experienceYears',
          visible: true,
          scopedSlots: { customRender: 'experienceYears' },
          sorter: true
          //sorter: (a, b) => a.experienceYears - b.experienceYears,
          //sorter: (a, b) => a.experienceYears.localeCompare(b.experienceYears),
        },
      ],
      pagination: {
        current: 1,
