...
<template>
  ...
  <base-input label="DepartureDate" type="text" placeholder="Enter DepartureDate" v-model="scheduleToAdd.departureDate"></base-input>
  <base-input label="ArrivalDate" type="text" placeholder="Enter ArrivalDate" v-model="scheduleToAdd.arrivalDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'arrivalDate',
          ...
          sorter: true
          //sorter: (a, b) => a.arrivalDate - b.arrivalDate,
