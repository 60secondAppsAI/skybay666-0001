...
<template>
  ...
  <base-input label="GatesCount" type="text" placeholder="Enter GatesCount" v-model="terminalToAdd.gatesCount"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: 'Gates Count',
		dataIndex: 'gatesCount',
          visible: true,
          scopedSlots: { customRender: 'gatesCount' },
          sorter: true
          //sorter: (a, b) => a.gatesCount - b.gatesCount,
          //sorter: (a, b) => a.gatesCount.localeCompare(b.gatesCount),
        },
      ],
      pagination: {
        current: 1,
