...
<template>
  ...
  <base-input label="TerminalCount" type="text" placeholder="Enter TerminalCount" v-model="airportToAdd.terminalCount"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'terminalCount',
          visible: true,
          scopedSlots: { customRender: 'terminalCount' },
          sorter: true
          //sorter: (a, b) => a.terminalCount - b.terminalCount,
          //sorter: (a, b) => a.terminalCount.localeCompare(b.terminalCount),
        },
      ],
      pagination: {
        current: 1,
